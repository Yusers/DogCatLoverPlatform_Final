...
public class CreateMessageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int conversation_id = Integer.parseInt(request.getParameter("conversation_id").toString());
            String content = request.getParameter("content");
            
            Message message = new Message(senderId, receiverId, content, conversation_id);

            MessageDAO.createMessage(message);
            request.setAttribute("CONVER_ID", conversation_id);
