 ...
 * @author overw
 */
public class LoadAllUserTradeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (us != null && !us.isEmpty()) {
                listTrade = TradeDAO.getAllTradeByAuthor(us);
                request.setAttribute("AUTHOR", us);
            } else {
                HttpSession session = request.getSession();
                Account author = (Account) session.getAttribute("USER");
                listTrade = TradeDAO.getAllTradeByAuthor(author.getUser_id());
            }
